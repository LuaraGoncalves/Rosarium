...
export function OracoesPage() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-church-bg text-church-text font-sans", children: [_jsx("header", { className: "bg-church-bg/95 border-b border-church-border backdrop-blur-md sticky top-0 z-50 py-6 transition-all", children: _jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [_jsx("div", { className: "mb-4", children: _jsxs("button", { onClick: () => navigate("/igreja"), className: "flex items-center gap-2 text-church-accent hover:text-church-accent-hover transition-colors", children: [_jsx(ArrowLeft, { className: "w-5 h-5" }), "Voltar"] }) }), _jsxs("div", { className: "flex items-center justify-center gap-3", children: [_jsx(Book, { className: "w-8 h-8 text-church-accent-hover" }), _jsx("h1", { className: "text-4xl text-center font-serif text-church-accent", children: "Ora\u00E7\u00F5es" })] })] }) }), _jsxs("div", { className: "max-w-6xl mx-auto px-4 py-12", children: [_jsxs("div", { className: "bg-church-bg-secondary rounded-2xl p-8 mb-12 border border-church-border-hover shadow-none", children: [_jsx("div", { className: "overflow-hidden h-64 mb-8 rounded-xl", children: _jsx("img", { src: "https://images.unsplash.com/photo-1616428882609-7443facdbe81?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiaWJsZSUyMG9wZW4lMjBib29rJTIwY2h1cmNofGVufDF8fHx8MTc3MzQwOTg2Mnww&ixlib=rb-4.1.0&q=80&w=1080", alt: "B\u00EDblia Aberta", className: "w-full h-full object-cover" }) }), _jsxs("div", { className: "mb-8", children: [_jsx("p", { className: "text-church-text/80 text-lg leading-relaxed text-center font-serif italic", children: "\"Orai sem cessar\" - 1 Tessalonicenses 5:17" }), _jsx("p", { className: "text-church-text/60 mt-4 leading-relaxed text-center", children: "A ora\u00E7\u00E3o \u00E9 a eleva\u00E7\u00E3o da alma a Deus. \u00C9 atrav\u00E9s dela que nos comunicamos com nosso Criador, agradecemos Suas b\u00EAn\u00E7\u00E3os, pedimos Sua ajuda e nos unimos a Ele em amor." })] })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: categorias.map((categoria, index) => {
                            const Icon = categoria.icon;
                            return (_jsxs("div", { className: "bg-church-bg-secondary rounded-2xl p-8 border border-church-border-hover shadow-none", children: [_jsxs("div", { className: "flex items-center gap-4 mb-6", children: [_jsx("div", { className: "w-14 h-14 rounded-full flex items-center justify-center bg-church-bg border border-church-border-hover", children: _jsx(Icon, { className: "w-7 h-7 text-church-accent-hover" }) }), _jsx("h2", { className: "text-2xl font-serif text-church-accent", children: categoria.titulo })] }), _jsx("ul", { className: "space-y-3", children: categoria.oracoes.map((oracao, idx) => (_jsxs("li", { onClick: () => setOracaoAberta({ titulo: oracao, texto: oracoesDatabase[oracao] || "Texto desta oração ainda não foi adicionado ao acervo." }), className: "bg-church-bg hover:bg-church-bg-darker p-4 rounded-lg cursor-pointer transition-all border border-church-border-hover hover:border-[#D4AF37]/50 flex justify-between items-center group", children: [_jsx("span", { className: "text-church-text font-medium group-hover:text-church-accent-hover transition-colors", children: oracao }), _jsx(Book, { className: "w-4 h-4 text-church-accent opacity-0 group-hover:opacity-100 transition-opacity" })] }, idx))) })] }, index));
                        }) })] }), oracaoAberta && (_jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200", children: _jsxs("div", { className: "bg-church-bg-secondary w-full max-w-2xl max-h-[85vh] rounded-2xl shadow-2xl flex flex-col border border-church-border animate-in zoom-in-95 duration-200", onClick: (e) => e.stopPropagation(), children: [_jsxs("div", { className: "flex items-center justify-between p-6 border-b border-church-border-hover shrink-0", children: [_jsxs("h3", { className: "text-2xl font-serif text-church-accent flex items-center gap-3", children: [_jsx(Book, { className: "w-5 h-5" }), oracaoAberta.titulo] }), _jsx("button", { onClick: () => setOracaoAberta(null), className: "p-2 rounded-full hover:bg-church-bg transition-colors text-church-text/60 hover:text-church-accent-hover", children: _jsx(X, { className: "w-6 h-6" }) })] }), _jsxs("div", { className: "p-8 overflow-y-auto custom-scrollbar", children: [_jsx("div", { className: "space-y-6", children: oracaoAberta.texto.split('\n').map((paragrafo, index) => (paragrafo.trim() !== '' ? (_jsx("p", { className: "text-lg leading-relaxed text-church-text/90 font-serif", children: paragrafo }, index)) : null)) }), _jsx("div", { className: "mt-12 text-center text-church-text/40", children: _jsx(Cross, { className: "w-4 h-4 mx-auto opacity-50" }) })] })] }) }))] }));
}
