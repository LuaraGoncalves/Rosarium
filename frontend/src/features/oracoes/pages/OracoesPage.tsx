...
const oracoesDatabase: Record<string, string> = {
  'Oferta do Dia':
    'Senhor meu Deus, a Vós elevo o meu pensamento no começo deste dia. Eu Vos adoro, eu Vos amo de todo o coração. Agradeço a Vossa imensa bondade por me terdes criado, redimido, feito cristão e me terdes conservado a vida nesta noite.\n\nOfereço-Vos todas as minhas ações, o meu trabalho e o meu sofrimento, para a Vossa glória e para o bem de todas as almas. Fazei que não Vos ofenda e dai-me a graça de cumprir a Vossa vontade.',
  'Oração da Manhã a Maria':
    'Ó minha Senhora e minha Mãe, eu me ofereço todo a Vós e, em prova de minha devoção para convosco, Vos consagro neste dia os meus olhos, os meus ouvidos, a minha boca, o meu coração e inteiramente todo o meu ser.\nE porque assim sou Vosso, ó incomparável Mãe, guardai-me e defendei-me como posse e propriedade Vossa. Amém.',
  ...
  'Exame de Consciência':
    'Meu Senhor e meu Deus, dai-me a luz para conhecer os meus pecados, e a graça para me arrepender deles e me emendar. (Faça uma breve pausa e reflita sobre o seu dia). Meu Deus, porque sois infinitamente bom e digno de ser amado, pesa-me de todo o coração de Vos ter ofendido. Proponho firmemente, com a Vossa graça, não tornar a pecar e fugir das ocasiões de pecar.',
  'Oração da Noite':
    'Meu Deus, eu Vos adoro e Vos amo com todo o meu coração. Agradeço-Vos todos os benefícios que de Vós recebi neste dia. Peço-Vos perdão por todos os meus pecados; dai-me a Vossa graça para nunca mais os cometer.\nProtegei a minha família, os meus amigos e todos aqueles por quem devo rezar. E a Vós, Virgem Maria, peço a Vossa proteção materna.',
  ...
  'Ato de Contrição':
    'Meu Deus, eu me arrependo de todo o coração de Vos ter ofendido, porque sois tão bom e amável. Prometo firmemente, com a ajuda da Vossa graça, não mais pecar e evitar as ocasiões de pecado. Amém.',
  ...
  'Oração ao Sagrado Coração':
    'Coração de Jesus, que por mim sofreste tanto, tende piedade de nós e do mundo inteiro! Sagrado Coração de Jesus, eu confio em Vós!',
