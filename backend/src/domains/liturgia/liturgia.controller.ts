      ...
      if (response.ok) {
        ...
        const normalizedData = {
          ...
          laudes: {
            ...
            oracao:
              rawData.oracao ||
              'Ó Deus, que iluminastes o mundo com a luz de Cristo, iluminai nossas mentes.',
          },
          hora_media: {
            ...
            leitura:
              ...
              'Ao meio-dia, o sol brilha, assim brilhe a vossa graça em nós.',
          ...
          vesperas: {
            ...
            leitura:
              ...
              rawData.evangelho?.texto ||
              'Ficai conosco, Senhor, pois a tarde cai.',
            magnificat:
          ...
          completas: {
            ...
            leitura:
              'Sede sóbrios e vigiai. O vosso adversário, o diabo, anda em derredor como um leão que ruge, procurando a quem devorar. Resisti-lhe, firmes na fé.',
            nunc_dimittis:
            ...
            oracao:
              'Visitai, Senhor, esta casa e afastai dela as ciladas do inimigo; nela habitem os vossos santos anjos, para nos guardar na paz, e a vossa bênção permaneça sempre sobre nós. Por Cristo, nosso Senhor. Amém.',
          },
        };
